...
import { FileSearch, Cpu, Map, CheckCircle2, ArrowRight } from "lucide-react";
  ...
  const steps = [
    {
      ...
      description:
        "Upload your resume, connect your GitHub, or paste your experience summary. We extract and organize your skills into a structured profile.",
    },
    {
      icon: Cpu,
      title: "Analyze your skills",
      description:
        "We compare your skill profile against real job descriptions and role requirements. This shows how your experience aligns with the market.",
    },
    {
      icon: Map,
      title: "Identify gaps",
      description:
        "We highlight the exact skills you’re missing or underdeveloped for your target role. Both technical and non-technical areas are included.",
    },
    {
      icon: CheckCircle2,
      title: "Build your path",
      description:
        "We turn those gaps into step-by-step project recommendations and learning actions. So you always know what to work on next.",
    },
  ];

  return (
    <div className="flex-grow w-full max-w-5xl mx-auto px-6 pt-4 pb-24 flex flex-col items-center">
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="text-center mb-16"
      >
        <h2 className="text-4xl font-bold dark:text-purple-50 text-slate-800 mb-4 tracking-tight">
          How Hexo Works
        </h2>
        <p className="dark:text-blue-100/70 text-slate-600 text-lg max-w-2xl">
          A simple system that turns your experience into a structured path
        ...
        {steps.map((step, index) => {
          ...
          return (
            ...
            >
              ...
              <div>
                <h3 className="text-xl font-semibold dark:text-purple-100 text-slate-800 mb-2 font-sans">
                  {step.title}
                </h3>
                <p className="dark:text-blue-100/60 text-slate-600 leading-relaxed text-sm font-sans">
                  {step.description}
                </p>
              </div>
            </motion.div>
      ...
      >
        ...
        <h3 className="dark:text-blue-100/90 text-slate-800 mb-6 font-semibold text-xl">
          Ready to get clarity on your next role?
        </h3>
        <button
